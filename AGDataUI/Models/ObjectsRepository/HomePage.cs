...
namespace AGDataUI.Models.ObjectsRepository
{
    public class HomePage
    {
        ...
        private By _company = By.XPath("//nav[@id='site-navigation']//ul[@id='primary-menu']//a[text() = 'Company']");
        private By _careers = By.XPath("//nav[@id='site-navigation']//ul[@id='primary-menu']//a[text() = 'Careers']");
